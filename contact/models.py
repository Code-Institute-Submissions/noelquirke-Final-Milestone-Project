...
class Email(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        contact_subject = render_to_string(
            'contact/templates/emails/contact_subject.txt',
            {'subject': subject})
        contact_body = render_to_string(
            'contact/templates/emails/contact_body.txt',
        ...
        thanks_subject = render_to_string(
            'contact/templates/emails/thanks_subject.txt',
            {'subject': subject})
        thanks_body = render_to_string(
            'contact/templates/emails/thanks_body.txt',
            {'name': name})
